...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView Location1,VminMaxwind,XminAvgwind,temp,humi,updatedtime1,Bdtemp1,Volt1;
                ...
                while(true){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Bdtemp1.setText(Station1data[0].getBdTemp()+"  °C");
                            Volt1.setText(Station1data[0].getVolt()+"  V");
                ...
                while(true){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Bdtemp2.setText(Station2data[0].getBdTemp()+"  °C");
                            Volt2.setText(Station2data[0].getVolt()+"  V");
                ...
                while(true){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Bdtemp3.setText(Station3data[0].getTemperature()+"  °C");
                            Volt3.setText(Station3data[0].getVoltage()+"  V");
