...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView VminMaxwind,XminAvgwind,temp,humi,updatedtime1,Bdtemp1,Volt1;
    private TextView Dept1,updatedtime2,Bdtemp2,Volt2;
    private TextView Dept2,Hourrain,DayRain,updatedtime3,Bdtemp3,Volt3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Bdtemp1 = findViewById(R.id.Bdtemp1_d);
        Volt1 = findViewById(R.id.Volt1_d);

        Dept1 = findViewById(R.id.Dept_d);
        updatedtime2 = findViewById(R.id.IIndUpdatetime_d);
        Bdtemp2 = findViewById(R.id.Bdtemp2_d);
        Volt2 = findViewById(R.id.Volt2_d);
        ...
        Bdtemp3 = findViewById(R.id.Bdtemp3_d);
        Volt3 = findViewById(R.id.Volt3_d);

        Warning = findViewById(R.id.Warning_img);
        Warning_y = findViewById(R.id.warniing_img);
                ...
                while(true){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Bdtemp1.setText(String.valueOf(Station1data[0].getBdTemp()));
                            Volt1.setText(String.valueOf(Station1data[0].getVolt()));
                ...
                while(true){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Bdtemp2.setText(String.valueOf(Station2data[0].getBdTemp()));
                            Volt2.setText(String.valueOf(Station2data[0].getVolt()));
                ...
                while(true){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            Bdtemp3.setText(String.valueOf(Station3data[0].getTemperature()));
                            Volt3.setText(String.valueOf(Station3data[0].getVoltage()));
